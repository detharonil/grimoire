...
**Targeted Effects.** Spells and other magical effects, such as _[magic missle](../magic-missile/)_ and _[charm person](../charm-person/)_, that target a creature or an object in the sphere have no effect on that target.
